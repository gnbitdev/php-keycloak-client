...
use KeycloakApiClient\Exception\EncryptionConfigurationException;
use UnexpectedValueException;

class Sdk extends AbstractProvider
{
    ...
    public function getResourceOwner(AccessToken $token)
    {
        ...
        $decrypt = $this->decryptResponse($response);

        return $this->createResourceOwner($decrypt, $token);
    }
